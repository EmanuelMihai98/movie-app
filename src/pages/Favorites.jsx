                    ...
                    <Link to={`/details/${favorite.id}`}>
                        {favorite && (
                            <img src={`https://image.tmdb.org/t/p/w500${favorite.poster_path}`}
                             alt={favorite.title}
                             className="hover:rotate-2 transition-transform w-[250px] md:w-[550px] md:ml-12 lg:w-[700px] lg:ml-96"
                             />)}
                    </Link>
                    <button className="h-fit  pl-4  pr-4 py-1 rounded bg-gradient-to-r from-red-500 via-red-700 to-red-900 border border-gray-900 hover:scale-125 duration-500 animate-pop md:ml-4 md:pl-5 md:pr-5 md:py-4
                                        lg:pl-8 lg:pr-8 lg:ml-20"
